...
export default function Marketing(){
    return(
        <div className="flex justify-center items-center flex-col">
            <div className="flex justify-center items-center flex-col">
                <div className="flex border bg-amber-100 text-amber-800 py-2 px-4 rounded-full shadow-md uppercase">
                    <Medal className="h-6 w-6 mr-4"/> 
                    1° Organizador de tareas
                </div>
                <h1 className="mt-4 text-xl md:text-2xl mb-4 font-bold">Ayuda al equipo de tareas a avanzar</h1>
